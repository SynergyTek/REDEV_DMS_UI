                ...
                <ul className="space-y-1">
                        ...
                        <li>
                            <Link
                                ...
                                className={`flex items-center gap-4 rounded-lg px-4 py-2 ${
                                    currentRoute === "/file"
                                        ? "bg-gray-200 bg-opacity-60 text-black dark:bg-gray-700 dark:text-white dark:bg-opacity-35"
                                        : "hover:bg-gray-200 hover:bg-opacity-60 hover:text-black dark:hover:bg-gray-700  dark:hover:bg-opacity-35 dark:hover:text-white"
                                }
                                `}
                            >
                        ...
                        <li>
                            <details className="group [&_summary::-webkit-details-marker]:hidden">
                                <summary
                                    className="group flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 transition-all hover:bg-gray-200 hover:bg-opacity-60 hover:text-black dark:hover:bg-gray-700 dark:hover:bg-opacity-35 dark:hover:text-white">
                                ...
                                <ul>
                                    <li>
                                        <Link
                                            href="/"
                                            className={"flex items-center rounded-lg px-4 pl-12 ml-0.5 py-2 hover:bg-gray-200 hover:bg-opacity-60 hover:text-black dark:hover:bg-gray-700 dark:hover:bg-opacity-35 dark:hover:text-white"}
                                        >
                ...
                <div className="p-2 mb-4 text-gray-500 overflow-y-auto absolute bottom-0">
                    <ul className="space-y-1">
                        <li>
                            <Link
                                href="/"
                                className={"flex items-center gap-4 rounded-lg px-4 py-2 text-gray-700 hover:bg-gray-200 hover:bg-opacity-60 hover:text-black dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:bg-opacity-35 dark:hover:text-white"}
                            >
