...
const Sidebar = () => {
	...
	return (
		<aside className="fixed left-0 z-30 w-72 p-2 h-screen transition-transform -translate-x-full sm:translate-x-0">
			<div
				className={
					"border-opacity-50 border-secondary-200 rounded-lg h-full bg-secondary-50 dark:bg-secondary-900 dark:text-primary-900 "
				}
			>
				...
				<div className="p-2 mb-4 text-secondary-500 dark:text-secondary-300 overflow-y-auto">
					<ul className="space-y-1">
						...
						<div
							className={
								"border-b-2 border-secondary-200 border-opacity-60 dark:border-secondary-800"
							}
						></div>
						<li>
						...
						<li>
							<details className="group [&_summary::-webkit-details-marker]:hidden">
								...
								<ul>
									...
									<li>
										<Link
											href="/masters/email-integration/"
											className={
												"flex items-center rounded-lg px-4 pl-12 ml-0.5 py-2 hover:bg-secondary-200 hover:bg-opacity-60 hover:text-black dark:hover:bg-secondary-700 dark:hover:bg-opacity-35 dark:hover:text-white"
											}
										>
