...
const ManageUserForm = ({ id, name, inputData }) => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setBtnStatus(true);
            const response = await axios.post("/dmsapi/portalAdmin/User/NewManagePortalUser", newData);
            setBtnStatus(false);
                                ...
                                render={() => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Select
                                                className="w-full"
                                                source="/dmsapi/cms/query/GetUserRolesList"
                                                map={{ key: "Id", value: "Name" }}
                                                ref={UserRoleRef}
                                                onSelect={() =>
                                                    form.setValue(
                                ...
                                render={() => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Select
                                                className="w-full"
                                                source="/dmsapi/cms/query/GetPortalsList"
                                                map={{ key: "Id", value: "Name" }}
                                                ref={PortalRef}
                                                onSelect={() =>
                                                    form.setValue(
                                ...
                                render={() => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Select
                                                className="w-full"
                                                source="/dmsapi/cms/user/GetLineManagersList"
                                                map={{ key: "Id", value: "Name" }}
                                ...
                                render={() => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Select
                                                className="w-full"
                                                source="/dmsapi/cms/user/GetSponsorsList"
                                                map={{ key: "Id", value: "Name" }}
                                                ref={SponsorIdRef}
                                                onSelect={() =>
                                                    form.setValue(
...
export default function ManageUser() {
    ...
    useEffect(() => {
        if (id) {
            axios
                .get(`/dmsapi/portalAdmin/User/NewEditUser?Id=${id}&portalId=6EA64B17-6959-4CB8-A5D2-33728AEBBBAC`)
                .then((res) => {
